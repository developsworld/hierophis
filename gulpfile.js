...
getPaths = () => {
  return {
    ...
    pages: {
      folder: 'pages',
      all: ['_theme/**/*'],
      md: ['_theme/**/*.md', '_theme/*.md'],
      html:   ['_theme/**/*.html', '_theme/*.html'],
      liquid: '_theme/**/*.liquid',
      liquidRoot: '_theme/',
      includes: '_theme/include/',
    ...
    js: {
      ...
      bootstrap: {
        all: [
          "./_theme/js/bootstrap/util.js",
          "./_theme/js/bootstrap/alert.js",
          "./_theme/js/bootstrap/button.js",
          "./_theme/js/bootstrap/carousel.js",
          "./_theme/js/bootstrap/collapse.js",
          "./_theme/js/bootstrap/dropdown.js",
          "./_theme/js/bootstrap/modal.js",
          "./_theme/js/bootstrap/tooltip.js",
          "./_theme/js/bootstrap/popover.js",
          "./_theme/js/bootstrap/scrollspy.js",
          "./_theme/js/bootstrap/toast.js",
          "./_theme/js/bootstrap/tab.js"
        ],
        index: "./_theme/js/bootstrap/index.js"
      },
      mrare: {
        all: "_theme/js/mrare/**/*.js",
        index: "_theme/js/mrare/index.js",
      }
    },
    scss: {
      folder: '_scss',
      all: '_scss/**/*',
      root: '_scss/*.scss',
      themeScss: ['_scss/theme.scss', '!_scss/user.scss', '!_scss/user-variables.scss'],
    },
    assets: {
      all: '_theme/assets/**/*',
      folder: '_theme/assets',
      allFolders: ['_theme/assets/css', '_theme/assets/img', '_theme/assets/fonts', '_theme/assets/video'],
    },
    css: {
      folder: 'assets/css',
    },
...
gulp.task('watch', function (done) {
  ...
  gulp.watch([paths.pages.html, paths.pages.md], {
    cwd: './'
...
// gulp.task('default', gulp.series('clean:dist', 'copy-assets', gulp.series('html', 'sass', 'sass-min', 'bootstrapjs', 'mrarejs')
